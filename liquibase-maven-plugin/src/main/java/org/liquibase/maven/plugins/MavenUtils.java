...
public class MavenUtils {
    ...
    /**
     * Obtains a {@link ClassLoader} that can load from the Maven project dependencies. If the dependencies have not be
     * resolved (or there are none) then this will just end up delegating to the parent {@link ClassLoader} of this
     * class.
     * 
     * @return The ClassLoader that can load the resolved dependencies for the Maven project.
     ...
     * 
     * @param urls
     *            The set to add the artifact file URL to.
     * @param artifact
     *            The Artifiact to resolve the file for.
