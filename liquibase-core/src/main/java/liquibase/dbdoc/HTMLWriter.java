...
public abstract class HTMLWriter {
    ...
    private void writeFooter(FileWriter fileWriter, String changeLog) throws IOException {
        ...
        fileWriter.append("<a href='http://www.liquibase.org' target='_TOP'>Liquibase ")
    ...
    private void writeHeader(Object object, FileWriter fileWriter) throws IOException {
        ...
        fileWriter.append("<head>").append("<title>").append(title).append("</title>")
        ...
        if (changes == null || changes.size() == 0) {
            ...
            for (Change change : changes) {
                if (!change.getChangeSet().equals(lastChangeSet)) {
                    ...
                    writeTD(fileWriter, "<a href='../changelogs/" + change.getChangeSet().getFilePath() + ".xml'>"
                            + change.getChangeSet().getFilePath() + "</a>");
                    writeTD(fileWriter, change.getChangeSet().getId());
                    writeTD(fileWriter, "<a href='../authors/" + change.getChangeSet().getAuthor().toLowerCase()
                    ...
                    if (StringUtils.trimToNull(change.getChangeSet().getComments()) != null) {
                        fileWriter.append("<TR><TD BGCOLOR='#EEEEFF' CLASS='TableSubHeadingColor' colspan='4'>")
                ...
                fileWriter.append("<TR BGCOLOR=\"white\" CLASS=\"TableRowColor\">\n");
                fileWriter.append("<td colspan='4'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;")
