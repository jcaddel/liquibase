...
public interface CustomSqlRollback {
     ...
     * 
     * @param database
     *            the target {@link liquibase.database.Database} associated to this change's rollback statements
     ...
     */
    public SqlStatement[] generateRollbackStatements(Database database) throws CustomChangeException,
