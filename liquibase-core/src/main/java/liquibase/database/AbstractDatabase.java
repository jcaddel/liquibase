...
public abstract class AbstractDatabase implements Database {
	...
	protected Map<String, DatabaseFunction> liquibaseFunctionMappings = new HashMap<String, DatabaseFunction>();
	...
	@Override
	public Map<String, DatabaseFunction> getLiquibaseFunctionMappings() {
		return liquibaseFunctionMappings;
	}

	public void setLiquibaseFunctionMappings(Map<String, DatabaseFunction> liquibaseFunctionMappings) {
		this.liquibaseFunctionMappings = liquibaseFunctionMappings;
	}
}
