...
/**
 * An interface used by {@link liquibase.executor.Executor} for mapping rows of a {@link java.sql.ResultSet} on a
 * per-row basis. Implementations of this interface perform the actual work of mapping each row to a result object, but
 * don't need to worry about exception handling. {@link java.sql.SQLException SQLExceptions} will be caught and handled
